...
public final class Constants {
	...
	public static final double ksVolts = 0.13136;
	public static final double kvVoltSecondsPerMeter = 3.1367;
	public static final double kaVoltSecondsSquaredPerMeter = 0.46915;
	// Example value only - as above, this must be tuned for your drive!
	public static final double kPDriveVel = 3.428;
	...
	public static final double kFlipDownArmSpeed = .65;
	...
	public static final double kRotatingSpeed = 1;
	...
	public static final int kExtendableClimberId = 30;
